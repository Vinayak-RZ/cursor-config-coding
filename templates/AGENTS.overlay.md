...
This project’s `.cursor` is the shared **coding config** (rules + skills). Keep
this file for **this repo only**.
...
Stack, deploy, and product invariants that are unique to this tree go below.

## This repo

- [What this app does, in one sentence]
- [How to run it]
- [Anything the shared config cannot know]
